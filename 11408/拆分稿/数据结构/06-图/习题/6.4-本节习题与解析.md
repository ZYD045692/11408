...
10. 用 Dijkstra 算法求一个带权有向图的从顶点 O 出发的最短路径，在算法执行的某个时刻，已求得的最短路径的顶点集合  $S = \{0, 2, 3, 4\}$，下一个选取的目标顶点是顶点 1，则可能修改的最短路径是（）。
...
15. 若一个有向图的顶点不能形成一个拓扑序列，则判定该有向图（）。
...
17. 已知有向图  $G=(V,E)$，其中  $V=\{v_1,v_2,v_3,v_4,v_5,v_6,$

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_326.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_327.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_328.jpg">

</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_329.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_330.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_331.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_332.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_333.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_334.jpg">

</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_335.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_336.jpg">
...
44. 【2021 统考真题】使用 Dijkstra 算法求下图中从顶点 1 到其余各顶点的最短路径，将当前找到的从顶点 1 到顶点 2, 3, 4, 5 的最短路径长度保存在数组 dist 中，求出第二条最短路径后，dist 中的内

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_337.jpg">

</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_338.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_339.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_340.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_341.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_342.jpg">
...
<table border=1 style='margin: auto; word-wrap: break-word;'><tr><td style='text-align: center; word-wrap: break-word;'>工序代号</td><td style='text-align: center; word-wrap: break-word;'>A</td><td style='text-align: center; word-wrap: break-word;'>B</td><td style='text-align: center; word-wrap: break-word;'>C</td><td style='text-align: center; word-wrap: break-word;'>D</td><td style='text-align: center; word-wrap: break-word;'>E</td><td style='text-align: center; word-wrap: break-word;'>F</td><td style='text-align: center; word-wrap: break-word;'>G</td><td style='text-align: center; word-wrap: break-word;'>H</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>所需时间</td><td style='text-align: center; word-wrap: break-word;'>3</td><td style='text-align: center; word-wrap: break-word;'>2</td><td style='text-align: center; word-wrap: break-word;'>2</td><td style='text-align: center; word-wrap: break-word;'>3</td><td style='text-align: center; word-wrap: break-word;'>4</td><td style='text-align: center; word-wrap: break-word;'>3</td><td style='text-align: center; word-wrap: break-word;'>2</td><td style='text-align: center; word-wrap: break-word;'>1</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>先驱工序</td><td style='text-align: center; word-wrap: break-word;'>—</td><td style='text-align: center; word-wrap: break-word;'>—</td><td style='text-align: center; word-wrap: break-word;'>A</td><td style='text-align: center; word-wrap: break-word;'>A</td><td style='text-align: center; word-wrap: break-word;'>B</td><td style='text-align: center; word-wrap: break-word;'>A</td><td style='text-align: center; word-wrap: break-word;'>C、E</td><td style='text-align: center; word-wrap: break-word;'>D</td></tr></table>
...
<img src="../../../../origin/2027数据结构/imgs/img_344.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_345.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_346.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_347.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_348.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_349.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_350.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_351.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_352.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_353.jpg">

</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_354.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_355.jpg">

</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_356.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_357.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_358.jpg">
...
第一个顶点和最后一个顶点相同的路径称为回路；序列中顶点不重复出现的路径称为简单路径；回路显然不是简单路径，说法 I 错误。稀疏图是边比较少的情况，邻接矩阵存储的空间复杂度为  $O(n^2)$，必将浪费大量的空间，而邻接表存储的空间复杂度为  $O(n+e)$，所以应选用邻接表，说法 II 错误。存在回路的有向图不存在拓扑序列，若拓扑排序输出结束后所余下的顶点都有前驱，则说明只得到了部分顶点的拓扑有序序列，图中存在回路，说法 III 正确。
...
<img src="../../../../origin/2027数据结构/imgs/img_359.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_360.jpg">

</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_361.jpg">

</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_362.jpg">

</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_363.jpg">
...
③本题要求执行输出语句后立刻退出递归，即执行完输出语句后立即出栈，因此后入栈的顶点先输出，结合②不难得出只有输出顶点  $v_i$ 的所有后继顶点  $v_j$ 后， $v_i$ 才会输出。综合上述分析，输出的顶点序列是逆拓扑有序序列。
42. B
...
在执行 Dijkstra 算法时，首先初始化  $\text{dist}[]$，若顶点 1 到顶点  $i$ ( $i = 2, 3, 4, 5$) 有边，就初始化为边的权值；若无边，就初始化为 $\infty$；初始化顶点集  $S$ 只含顶点 1。Dijkstra 算法每次选择一个到顶点 1 距离最近的顶点  $j$ 加入顶点集  $S$，并判断由顶点 1 绕行顶点  $j$ 后到任意一个顶点  $k$ 是否距离更短，若距离更短（ $\text{dist}[j] + \text{arcs}[j][k] < \text{dist}[k]$），则将  $\text{dist}[x]$ 更新为  $\text{dist}[j] + \text{arcs}[j][k]$；重复该过程，直至所有顶点都加入顶点集  $S$。数组  $\text{dist}$ 的变化过程如下图所示，可知将第二个顶点 5 加入顶点集  $S$ 后，数组  $\text{dist}$ 更新为 21, 3, 14, 6。
...
<img src="../../../../origin/2027数据结构/imgs/img_364.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_365.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_366.jpg">
...
<table border=1 style='margin: auto; word-wrap: break-word;'><tr><td rowspan="2">顶点</td><td colspan="5">从顶点 1 到各终点的 dist 值</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>第 1 轮</td><td style='text-align: center; word-wrap: break-word;'>第 2 轮</td><td style='text-align: center; word-wrap: break-word;'>第 3 轮</td><td style='text-align: center; word-wrap: break-word;'>第 4 轮</td><td style='text-align: center; word-wrap: break-word;'></td></tr><tr><td style='text-align: center; word-wrap: break-word;'>2</td><td style='text-align: center; word-wrap: break-word;'>7  $v_1, v_2$</td><td style='text-align: center; word-wrap: break-word;'></td><td style='text-align: center; word-wrap: break-word;'></td><td style='text-align: center; word-wrap: break-word;'></td><td style='text-align: center; word-wrap: break-word;'></td></tr><tr><td style='text-align: center; word-wrap: break-word;'>3</td><td style='text-align: center; word-wrap: break-word;'>11  $v_1, v_3$</td><td style='text-align: center; word-wrap: break-word;'>11  $v_1, v_3$</td><td style='text-align: center; word-wrap: break-word;'></td><td style='text-align: center; word-wrap: break-word;'></td><td style='text-align: center; word-wrap: break-word;'></td></tr><tr><td style='text-align: center; word-wrap: break-word;'>4</td><td style='text-align: center; word-wrap: break-word;'>∞</td><td style='text-align: center; word-wrap: break-word;'>16  $v_1, v_2, v_4$</td><td style='text-align: center; word-wrap: break-word;'>16  $v_1, v_2, v_4$</td><td style='text-align: center; word-wrap: break-word;'></td><td style='text-align: center; word-wrap: break-word;'></td></tr><tr><td style='text-align: center; word-wrap: break-word;'>5</td><td style='text-align: center; word-wrap: break-word;'>∞</td><td style='text-align: center; word-wrap: break-word;'>∞</td><td style='text-align: center; word-wrap: break-word;'>18  $v_1, v_3, v_5$</td><td style='text-align: center; word-wrap: break-word;'>18  $v_1, v_3, v_5$</td><td style='text-align: center; word-wrap: break-word;'></td></tr><tr><td style='text-align: center; word-wrap: break-word;'>6</td><td style='text-align: center; word-wrap: break-word;'>∞</td><td style='text-align: center; word-wrap: break-word;'>∞</td><td style='text-align: center; word-wrap: break-word;'>19  $v_1, v_3, v_6$</td><td style='text-align: center; word-wrap: break-word;'>19  $v_1, v_3, v_6$</td><td style='text-align: center; word-wrap: break-word;'>19  $v_1, v_3, v_6$</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>集合 S</td><td style='text-align: center; word-wrap: break-word;'>{1, 2}</td><td style='text-align: center; word-wrap: break-word;'>{1, 2, 3}</td><td style='text-align: center; word-wrap: break-word;'>{1, 2, 3, 4}</td><td style='text-align: center; word-wrap: break-word;'>{1, 2, 3, 4, 5}</td><td style='text-align: center; word-wrap: break-word;'>{1, 2, 3, 4, 5, 6}</td></tr></table>
...
<img src="../../../../origin/2027数据结构/imgs/img_367.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_368.jpg">

</div>

<div style="text-align: center;">(a) 图 G</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_369.jpg">

</div>

<div style="text-align: center;">(b) 两种算法产生的生成树</div>
...
<img src="../../../../origin/2027数据结构/imgs/img_370.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_371.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_372.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_373.jpg">
...
<div style="text-align: center;">弧结点的两种基本形态</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_374.jpg">
...
<img src="../../../../origin/2027数据结构/imgs/img_375.jpg">

</div>

3 ）计算结果如下表所示。

<table border=1 style='margin: auto; word-wrap: break-word;'><tr><td style='text-align: center; word-wrap: break-word;'></td><td style='text-align: center; word-wrap: break-word;'>目的网络</td><td style='text-align: center; word-wrap: break-word;'>路径</td><td style='text-align: center; word-wrap: break-word;'>代价（费用）</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>步骤1</td><td style='text-align: center; word-wrap: break-word;'>192.1.1.0/24</td><td style='text-align: center; word-wrap: break-word;'>直接到达</td><td style='text-align: center; word-wrap: break-word;'>1</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>步骤2</td><td style='text-align: center; word-wrap: break-word;'>192.1.5.0/24</td><td style='text-align: center; word-wrap: break-word;'>R1→R3→192.1.5.0/24</td><td style='text-align: center; word-wrap: break-word;'>3</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>步骤3</td><td style='text-align: center; word-wrap: break-word;'>192.1.6.0/24</td><td style='text-align: center; word-wrap: break-word;'>R1→R2→192.1.6.0/24</td><td style='text-align: center; word-wrap: break-word;'>4</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>步骤4</td><td style='text-align: center; word-wrap: break-word;'>192.1.7.0/24</td><td style='text-align: center; word-wrap: break-word;'>R1→R2→R4→192.1.7.0/24</td><td style='text-align: center; word-wrap: break-word;'>8</td></tr></table>
...
<img src="../../../../origin/2027数据结构/imgs/img_376.jpg">

</div>

<div style="text-align: center;">方案1</div>

<div style="text-align: center;">

<img src="../../../../origin/2027数据结构/imgs/img_377.jpg">

</div>

<div style="text-align: center;">方案2</div>
