...
【解析】(1)由题设$A\xi_{i}=\lambda_{i}\xi_{i},i=1,2,3$，且$\alpha=\xi_{1}+\xi_{2}+\xi_{3}$，故

$$\begin{align*}A\boldsymbol{\alpha}=A(\boldsymbol{\xi}_{1}+\boldsymbol{\xi}_{2}+\boldsymbol{\xi}_{3})&=A\boldsymbol{\xi}_{1}+A\boldsymbol{\xi}_{2}+A\boldsymbol{\xi}_{3}=\lambda_{1}\boldsymbol{\xi}_{1}+\lambda_{2}\boldsymbol{\xi}_{2}+\lambda_{3}\boldsymbol{\xi}_{3}\;,\\A^{2}\boldsymbol{\alpha}&=\lambda_{1}^{2}\boldsymbol{\xi}_{1}+\lambda_{2}^{2}\boldsymbol{\xi}_{2}+\lambda_{3}^{2}\boldsymbol{\xi}_{3}\;.\end{align*}$$

设存在数$k_{1}$，$k_{2}$，$k_{3}$，使得

$$k_{1}\boldsymbol{\alpha}+k_{2}\boldsymbol{A}\boldsymbol{\alpha}+k_{3}\boldsymbol{A}^{2}\boldsymbol{\alpha}=\mathbf{0}.$$

将$\alpha=\xi_{1}+\xi_{2}+\xi_{3}$，$A\alpha=\lambda_{1}\xi_{1}+\lambda_{2}\xi_{2}+\lambda_{3}\xi_{3}$，$A^{2}\alpha=\lambda_{1}^{2}\xi_{1}+\lambda_{2}^{2}\xi_{2}+\lambda_{3}^{2}\xi_{3}$代入(*)式，整理得

$$({\boldsymbol{k}}_{1}+{\boldsymbol{k}}_{2}{\boldsymbol{\lambda}}_{1}+{\boldsymbol{k}}_{3}{\boldsymbol{\lambda}}_{1}^{2}){\boldsymbol{\xi}}_{1}+({\boldsymbol{k}}_{1}+{\boldsymbol{k}}_{2}{\boldsymbol{\lambda}}_{2}+{\boldsymbol{k}}_{3}{\boldsymbol{\lambda}}_{2}^{2}){\boldsymbol{\xi}}_{2}+({\boldsymbol{k}}_{1}+{\boldsymbol{k}}_{2}{\boldsymbol{\lambda}}_{3}+{\boldsymbol{k}}_{3}{\boldsymbol{\lambda}}_{3}^{2}){\boldsymbol{\xi}}_{3}=\mathbf{0}~.$$

因$\lambda_{1}, \lambda_{2}, \lambda_{3}$互不相同，故$\xi_{1}, \xi_{2}, \xi_{3}$线性无关，于是

$$\left\{\begin{aligned}&k_{1}+k_{2}\lambda_{1}+k_{3}\lambda_{1}^{2}=0,\\ &k_{1}+k_{2}\lambda_{2}+k_{3}\lambda_{2}^{2}=0,\\ &k_{1}+k_{2}\lambda_{3}+k_{3}\lambda_{3}^{2}=0,\end{aligned}\right.$$

系数行列式

$$\begin{vmatrix}1&\lambda_{1}&\lambda_{1}^{2}\\1&\lambda_{2}&\lambda_{2}^{2}\\1&\lambda_{3}&\lambda_{3}^{2}\end{vmatrix}=(\lambda_{3}-\lambda_{1})(\lambda_{3}-\lambda_{2})(\lambda_{2}-\lambda_{1})\neq0,$$

故$k_1 = k_2 = k_3 = 0$，即$\alpha, A\alpha, A^2\alpha$线性无关，于是$P = [\alpha, A\alpha, A^2\alpha]$可逆。

(2)由$(A^{3}-A)a=0$，得$A^{3}a=Aa$，故

$$\boldsymbol{A}\boldsymbol{P}=\boldsymbol{A}\left[\boldsymbol{\alpha},\boldsymbol{A}\boldsymbol{\alpha},\boldsymbol{A}^{2}\boldsymbol{\alpha}\right]=\left[\boldsymbol{A}\boldsymbol{\alpha},\boldsymbol{A}^{2}\boldsymbol{\alpha},\boldsymbol{A}\boldsymbol{\alpha}\right]=\left[\boldsymbol{\alpha},\boldsymbol{A}\boldsymbol{\alpha},\boldsymbol{A}^{2}\boldsymbol{\alpha}\right]\begin{bmatrix}0&0&0\\ 1&0&1\\ 0&1&0\end{bmatrix}\xrightarrow{ 记 }\boldsymbol{P}\boldsymbol{B}\text{,}$$

于是$P^{-1}AP=B$，即$A\sim B$

令$\left|\lambda\boldsymbol{E}-\boldsymbol{B}\right|=0$,即
$$\begin{aligned}\left|\begin{matrix}{{{\lambda}}}&{{{0}}}&{{{0}}} \\{{{-1}}}&{{{\lambda}}}&{{{-1}}} \\{{{0}}}&{{{-1}}}&{{{\lambda}}}\end{matrix}\right|&=\lambda(\lambda+1)(\lambda-1)=0,\end{aligned}$$

解得$B$的特征值，即为$A$的特征值$\lambda_1=0$，$\lambda_2=-1$，$\lambda_3=1$，则对于$A-3E$，特征值为$-3$，$-4$，$-2$，故$|A-3E|=(-3)\times(-4)\times(-2)=-24$。
