...
【解析】(1) 由于$A = \left\{ \max \{X, Y\} \geq 0 \right\} = \{X, Y$至少有一个大于等于 0$\} = \{X \geq 0\} \cup \{Y \geq 0\}$，故

$$P(A)=P\left\{X\geqslant0\right\}+P\left\{Y\geqslant0\right\}-P\left\{X\geqslant0,Y\geqslant0\right\}=\frac{4}{7}+\frac{4}{7}-\frac{3}{7}=\frac{5}{7}.$$

(2)由全集分解法，有

$$\begin{aligned}A=&\left\{\max\left\{X,Y\right\}\geq0\right\}=\left\{\max\left\{X,Y\right\}\geq0,\varOmega\right\}\\=&\left\{\max\left\{X,Y\right\}\geq0\right\}\bigcap\left(\left\{\min\left\{X,Y\right\}<0\right\}\bigcup\left\{\min\left\{X,Y\right\}\geq0\right\}\right)\\=&\left\{\max\left\{X,Y\right\}\geq0,\min\left\{X,Y\right\}<0\right\}\bigcup\left\{\max\left\{X,Y\right\}\geq0,\min\left\{X,Y\right\}\geq0\right\}\\=&B\bigcup\left\{\min\left\{X,Y\right\}\geq0\right\}=B\bigcup\left\{X\geq0,Y\geq0\right\},\\ \end{aligned}$$

故

$$P(B)=P(A)-P\left\{X\geqslant0,Y\geqslant0\right\}=\frac{5}{7}-\frac{3}{7}=\frac{2}{7}.$$
