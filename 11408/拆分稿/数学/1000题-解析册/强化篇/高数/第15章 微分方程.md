...
$$\frac{\partial u}{\partial x}=f^{\prime}(x),\frac{\partial^{2}u}{\partial x^{2}}=f^{\prime \prime}(x),\frac{\partial u}{\partial y}=g^{\prime}(y),\frac{\partial^{2}u}{\partial y^{2}}=g^{\prime \prime}(y),\frac{\partial^{2}u}{\partial x\partial y}=0,$$

代入方程，有

$$\{1+[g^{\prime}(y)]^{2}\}f^{\prime \prime}(x)+\{1+[f^{\prime}(x)]^{2}\}g^{\prime \prime}(y)=0\ ,$$

分离变量，得

$$\frac{f^{\prime \prime}(x)}{1+[f^{\prime}(x)]^{2}}=-\frac{g^{\prime \prime}(y)}{1+[g^{\prime}(y)]^{2}}\stackrel{ 令 }{=}C_{1},$$
...
$$f^{\prime}(x)=\tan(C_{1}x+C_{2}),$$

再对x积分，有

$$f(x)=-\frac{1}{C_{1}}\ln\left|\cos(C_{1}x+C_{2})\right|+C_{3}.$$

同理，

$$g(y)=\frac{1}{C_{1}}\ln\left|\cos(C_{1}y+C_{4})\right|+C_{5},$$

$$u(x,y)=\frac{1}{C_{1}}\ln\left|\frac{\cos(C_{1}y+C_{4})}{\cos(C_{1}x+C_{2})}\right|+C.$$
