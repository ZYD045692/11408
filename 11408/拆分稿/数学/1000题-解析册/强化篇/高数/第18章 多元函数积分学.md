...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_93.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_94.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_95.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_96.jpg">
...
【解析】积分区域及其在 xOy 面上的投影域如图所示.

由对称性，得

$$\iint_{\Sigma}\left|x\right|y\mathrm{d}S=0,$$

Σ在xOy面上的投影域为$D=\left\{(x,y)\middle|x^{2}+y^{2}\leq\frac{8}{9}m\right\}$，故

<div style="text-align: center;">

<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_97.jpg">

</div>


$$\begin{aligned} 原式 =&\iint\limits_{Σ }\frac{1}{z}\mathrm{d}S=\iint\limits_{D}\frac{1}{\sqrt{m-x^{2}-y^{2}}}\sqrt{1+(z_{x}^{\prime})^{2}+(z_{y}^{\prime})^{2}}\mathrm{d}x\mathrm{d}y\\=&\iint\limits_{D}\frac{1}{\sqrt{m-x^{2}-y^{2}}}\sqrt{1+\frac{x^{2}+y^{2}}{m-x^{2}-y^{2}}}\mathrm{d}x\mathrm{d}y=\sqrt{m}\iint\limits_{D}\frac{1}{m-x^{2}-y^{2}}\mathrm{d}x\mathrm{d}y\\=&\sqrt{m}\int_{0}^{2\pi}\mathrm{d}\theta\int_{0}^{\frac{2\sqrt{2m}}{3}}\frac{1}{m-r^{2}}r\mathrm{d}r=\sqrt{m}\bullet\left(-\frac{1}{2}\right)\left[\ln(m-r^{2})\Big|_{r=0}^{r=\frac{2\sqrt{2m}}{3}}\right]\bullet2\pi\\=&-\sqrt{m}\pi\bigg(\ln\frac{m}{9}-\ln m\bigg)=2\pi\sqrt{m}\ln3.\end{aligned}$$
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_98.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_99.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_100.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_101.jpg">

</div>


对于$0 \leq z \leq 1$，记$D_{z} = \left\{(x, y) \mid x^{2} + (y - z)^{2} \leq (1 - z)^{2}\right\}$。因为
...
$$\iiint\limits_{D}y\mathrm{d}x\mathrm{d}y\mathrm{d}z=\int_{0}^{1}\mathrm{d}z\iint\limits_{D_{z}}y\mathrm{d}x\mathrm{d}y=\int_{0}^{1}\overline{\gamma}S_{D_{z}}\mathrm{d}z=\int_{0}^{1}z\cdot\pi(1-z)^{2}\mathrm{d}z=\frac{\pi}{12},$$

<div style="text-align: center;">

<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_102.jpg">
...
所以$\overline{y}=\frac{\iiint\limits_{D}ydx\mathrm{d}y\mathrm{d}z}{V}=\frac{1}{4}$，$\overline{z}=\frac{\iiint\limits_{D}z\mathrm{d}x\mathrm{d}y\mathrm{d}z}{V}=\frac{1}{4}$。故Ω的形心坐标为$\left(0,\frac{1}{4},\frac{1}{4}\right)$。

【注】①考生可从第(1)问中学到求锥面方程的一般方法，在考研题中，命题人给出方程$x^{2}+(y-z)^{2}=(1-z)^{2}$时，很多考生不知所云，这里的第(1)问回答了此问题.

②若不画图，把$(x,y,z)$与$(-x,y,z)$代入表达式，表达式不变，也可知锥面关于yOz平面对称，于是$\bar{x}=0$。
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_103.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_104.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_105.jpg">
