...
$$E(X)=\int_{-\infty}^{+\infty}x f(x)\mathrm{d}x=0,E(X\big|X\big|)=\int_{-\infty}^{+\infty}x\big|x\big|f(x)\mathrm{d}x=0,$$

因此  $\mathrm{Cov}(X,|X|)=E(X|X|)-E(X)E(|X|)=0$ ，知 X 与  $\left|X\right|$ 不相关.

② $P\{X \leqslant x_{0}\} = \int_{-\infty}^{x_{0}} f(x) \, dx$，取 $x_{0} = 1$，则

$$P\left\{X\leq1\right\}=\frac{1}{2}\int_{-\infty}^{1}\mathrm{e}^{-|x|}\mathrm{d}x=\frac{1}{2}\int_{-\infty}^{0}\mathrm{e}^{x}\mathrm{d}x+\frac{1}{2}\int_{0}^{1}\mathrm{e}^{-x}\mathrm{d}x=1-\frac{1}{2}\mathrm{e}^{-1}$$

$$P\left\{\left|X\right|\leq1\right\}=\frac{1}{2}\int_{-1}^{1}\mathrm{e}^{-|x|}\mathrm{d}x=\int_{0}^{1}\mathrm{e}^{-x}\mathrm{d}x=1-\mathrm{e}^{-1}.$$
...
<img src="../../../../origin/27张宇1000题数一【解析册】/imgs/img_127.jpg">
...
<img src="../../../../origin/27张宇1000题数一【解析册】/imgs/img_128.jpg">
...
<img src="../../../../origin/27张宇1000题数一【解析册】/imgs/img_129.jpg">
