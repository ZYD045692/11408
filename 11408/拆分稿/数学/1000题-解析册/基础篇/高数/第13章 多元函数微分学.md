...
$$\frac{\partial g}{\partial x}=y-f_{u}^{\prime}\bullet\left(-\frac{y}{x^{2}}\right)-f_{v}^{\prime}\bullet\frac{1}{y},\frac{\partial g}{\partial y}=x-f_{u}^{\prime}\bullet\frac{1}{x}-f_{v}^{\prime}\bullet\left(-\frac{x}{y^{2}}\right),$$

$$\begin{align*}\frac{\partial^{2}g}{\partial x^{2}}=&\frac{y}{x^{2}}\Bigg[f_{uu}^{\prime \prime}\bullet\left(-\frac{y}{x^{2}}\right)+f_{uv}^{\prime \prime}\bullet\frac{1}{y}\Bigg]+f_{u}^{\prime}\bullet\left(-\frac{2y}{x^{3}}\right)-\frac{1}{y}\Bigg[f_{vu}^{\prime \prime}\bullet\left(-\frac{y}{x^{2}}\right)+f_{vv}^{\prime \prime}\bullet\frac{1}{y}\Bigg]\\=&-\frac{y^{2}}{x^{4}}f_{uu}^{\prime \prime}+\frac{2}{x^{2}}f_{uv}^{\prime \prime}-\frac{1}{y^{2}}f_{vv}^{\prime \prime}-\frac{2y}{x^{3}}f_{u}^{\prime}\;,\\\end{align*}$$

$$\begin{align*}\frac{\partial^{2}g}{\partial x\partial y}=&1+f_{u}^{\prime}\bullet\frac{1}{x^{2}}+\frac{y}{x^{2}}\Bigg[f_{uu}^{\prime \prime}\bullet\frac{1}{x}+f_{uv}^{\prime \prime}\bullet\left(-\frac{x}{y^{2}}\right)\Bigg]+\frac{1}{y^{2}}f_{v}^{\prime}-\frac{1}{y}\Bigg[f_{vu}^{\prime \prime}\bullet\frac{1}{x}+f_{vv}^{\prime \prime}\bullet\left(-\frac{x}{y^{2}}\right)\Bigg]\\=&1+\frac{y}{x^{3}}f_{uu}^{\prime \prime}-\frac{2}{xy}f_{uv}^{\prime \prime}+\frac{x}{\gamma^{3}}f_{vv}^{\prime \prime}+\frac{1}{x^{2}}f_{u}^{\prime}+\frac{1}{\gamma^{2}}f_{v}^{\prime}\ ,\end{align*}$$

$$\begin{aligned}\frac{\partial^{2}g}{\partial y^{2}}=&-\frac{1}{x}\Bigg[f_{uu}^{\prime \prime}\bullet\frac{1}{x}+f_{uv}^{\prime \prime}\bullet\left(-\frac{x}{y^{2}}\right)\Bigg]-\frac{2x}{y^{3}}f_{v}^{\prime}+\frac{x}{y^{2}}\Bigg[f_{vu}^{\prime \prime}\bullet\frac{1}{x}+f_{vv}^{\prime \prime}\bullet\left(\frac{x}{-y^{2}}\right)\Bigg]\\=&-\frac{1}{x^{2}}f_{uu}^{\prime \prime}+\frac{2}{y^{2}}f_{uv}^{\prime \prime}-\frac{x^{2}}{y^{4}}f_{vv}^{\prime \prime}-\frac{2x}{y^{3}}f_{v}^{\prime}\mathrm{~,~}\end{aligned}$$
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_19.jpg">
...
$$\frac{\partial z}{\partial x}=y f\left(\frac{y}{x}\right)+x y f^{\prime}\left(\frac{y}{x}\right)\bullet\left(-\frac{y}{x^{2}}\right)=y f\left(\frac{y}{x}\right)-\frac{y^{2}}{x}f^{\prime}\left(\frac{y}{x}\right),$$
...
$$\begin{aligned}S=\left|\int_{0}^{1}f(x)\mathrm{d}x\right|&=\left|\int_{0}^{1}\frac{x}{2}\ln x\mathrm{d}x\right|=\left|\frac{1}{2}\int_{0}^{1}\ln x\mathrm{d}\left(\frac{1}{2}x^{2}\right)\right|=\left|\frac{1}{4}x^{2}\ln x\right|_{0}^{1}-\frac{1}{4}\int_{0}^{1}x\mathrm{d}x\bigg|=\frac{1}{8}\\ &\\ &V=\int_{0}^{1}\pi[f(x)]^{2}\mathrm{d}x=\int_{0}^{1}\pi\left(\frac{x}{2}\ln x\right)^{2}\mathrm{d}x=\frac{\pi}{4}\int_{0}^{1}x^{2}\ln^{2}x\mathrm{d}x\\ &\\ &\xrightarrow{ 令 \ln x=t}\frac{\pi}{4}\int_{-\infty}^{0}\mathrm{e}^{2t}\cdot t^{2}\cdot\mathrm{e}^{t}\mathrm{d}t=\frac{\pi}{4}\int_{-\infty}^{0}\mathrm{e}^{3t}\cdot t^{2}\mathrm{d}t\\ &\\ &=\frac{\pi}{4}\int_{-\infty}^{0}t^{2}\mathrm{d}\left(\frac{1}{3}\mathrm{e}^{3t}\right)=\frac{\pi}{12}\mathrm{e}^{3t}\cdot t^{2}\bigg|_{-\infty}^{0}-\frac{\pi}{6}\int_{-\infty}^{0}t\mathrm{e}^{3t}\mathrm{d}t\\ &\\ &=-\frac{\pi}{6}\int_{-\infty}^{0}t\mathrm{d}\left(\frac{1}{3}\mathrm{e}^{3t}\right)=-\frac{\pi}{18}\mathrm{e}^{3t}\cdot t\bigg|_{-\infty}^{0}+\frac{\pi}{18}\int_{-\infty}^{0}\mathrm{e}^{3t}\mathrm{d}t=\frac{\pi}{54}.\\ \end{aligned}$$
...
$$\frac{\partial^{2}u}{\partial y^{2}}=\mathrm{e}^{ax+by}\left(\frac{\partial^{2}v}{\partial y^{2}}+2b\frac{\partial v}{\partial y}+\bar{b}^{2}v\right).$$

将上述各式代入原等式，整理得

$$2\frac{\partial^{2}\nu}{\partial x^{2}}-2\frac{\partial^{2}\nu}{\partial y^{2}}+(4a+3)\frac{\partial\nu}{\partial x}+(3-4b)\frac{\partial\nu}{\partial y}+(2a^{2}-2b^{2}+3a+3b)\nu=0.$$
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_20.jpg">

</div>


故 $\frac{\partial^{2}u}{\partial x^{2}}+2\frac{\partial^{2}u}{\partial x\partial y}+\frac{\partial^{2}u}{\partial y^{2}}=\frac{\partial^{2}u}{\partial\xi^{2}}=0$，即 $\frac{\partial^{2}u}{\partial\xi^{2}}=0$

#### 17.

【解析】方程 $F\left(x+\frac{z}{y},y+\frac{z}{x}\right)=0$两边分别对x求偏导，得

$$F_{1}^{\prime}\bullet\left(1+\frac{1}{y}\bullet\frac{\partial z}{\partial x}\right)+F_{2}^{\prime}\bullet\left(-\frac{z}{x^{2}}+\frac{1}{x}\bullet\frac{\partial z}{\partial x}\right)=0,$$

则

$$\frac{\partial z}{\partial x}=\frac{y(z F_{2}^{\prime}-x^{2}F_{1}^{\prime})}{x(x F_{1}^{\prime}+y F_{2}^{\prime})}.$$

方程 $F\left(x+\frac{z}{y},y+\frac{z}{x}\right)=0$两边分别对y求偏导，得

$$F_{1}^{\prime}\bullet\left(-\frac{z}{y^{2}}+\frac{1}{y}\bullet\frac{\partial z}{\partial y}\right)+F_{2}^{\prime}\bullet\left(1+\frac{1}{x}\bullet\frac{\partial z}{\partial y}\right)=0,$$

则

$$\frac{\partial z}{\partial y}=\frac{x(z F_{1}^{\prime}-y^{2}F_{2}^{\prime})}{y(x F_{1}^{\prime}+y F_{2}^{\prime})}\;.$$
