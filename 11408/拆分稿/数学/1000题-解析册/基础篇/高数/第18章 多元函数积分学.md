...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_32.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_33.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_34.jpg">
...
【解析】曲面  $\Sigma$ 在 yOz 坐标面的投影域为  $D=\{(y,z)|y^{2}+z^{2}\leq1\}$，因为  $\frac{\partial x}{\partial y}=2y$， $\frac{\partial x}{\partial z}=2z$，所以

$$\begin{aligned}I=&\iint\limits_{ Σ }(x-1)\mathrm{d}y\mathrm{d}z+(y-1)^{3}\mathrm{d}z\mathrm{d}x+(z-1)^{3}\mathrm{d}x\mathrm{d}y\\=&\iint\limits_{D}[1-y^{2}-z^{2}+2y(y-1)^{3}+2z(z-1)^{3}]\mathrm{d}y\mathrm{d}z\\=&\iint\limits_{D}(2y^{4}+2z^{4}-6y^{3}-6z^{3}+5y^{2}+5z^{2}-2y-2z+1)\mathrm{d}y\mathrm{d}z.\end{aligned}$$

因为区域D关于y,z坐标轴对称，所以 $\iint_{D}(-6y^{3}-6z^{3}-2y-2z)dydz=0$，故

$$\begin{aligned}I=&\iint\limits_{D}(2y^{4}+2z^{4}+5y^{2}+5z^{2}+1)\mathrm{d}y\mathrm{d}z\\=&\int_{0}^{2\pi}\mathrm{d}\theta\int_{0}^{1}[2r^{4}(\cos^{4}\theta+\sin^{4}\theta)+5r^{2}+1]r\mathrm{d}r\\=&\int_{0}^{2\pi}\left[\frac{1}{3}\left(\cos^{4}\theta+\sin^{4}\theta\right)+\frac{7}{4}\right]\mathrm{d}\theta\\=&\frac{7}{2}\pi+\frac{8}{3}\int_{0}^{\frac{\pi}{2}}\sin^{4}\theta\mathrm{d}\theta=4\pi.\end{aligned}$$
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_35.jpg">
...
<img src="../../../../../origin/27张宇1000题数一【解析册】/imgs/img_36.jpg">
