...
03. 某计算机的数据采用小端方式存储，减法指令“sub ax, imm”的功能为(ax)−imm→ax，imm 表示立即数，该指令对应的十六进制机器码为 2dxxx（从左到右以字节为单位由低地址到高地址），其中 xxxx 对应 imm 的机器码，若 imm = -3，(ax) = 7，则该指令对应的机器码和执行后 OF 标志位的值分别为（）。
...
02. 【2019 统考真题】已知  $f(n) = n! = n \times (n-1) \times (n-2) \times \cdots \times 2 \times 1$，计算  $f(n)$ 的 C 语言函数  $f(1)$ 的源程序（阴影部分）及其在 32 位计算机 M 上的部分机器级代码如下：
int f1(int n) {
...
<table border=1 style='margin: auto; word-wrap: break-word;'><tr><td colspan="4">for ( i = 0; i < 24; i++)</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>1</td><td style='text-align: center; word-wrap: break-word;'>00401072</td><td style='text-align: center; word-wrap: break-word;'>C7 45 F8 00 00 00 00</td><td style='text-align: center; word-wrap: break-word;'>mov [ebp-8], 0</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>2</td><td style='text-align: center; word-wrap: break-word;'>00401079</td><td style='text-align: center; word-wrap: break-word;'>EB 09</td><td style='text-align: center; word-wrap: break-word;'>jmp 00401084h</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>3</td><td style='text-align: center; word-wrap: break-word;'>0040107B</td><td style='text-align: center; word-wrap: break-word;'>8B 55 F8</td><td style='text-align: center; word-wrap: break-word;'>mov eax, [ebp-8]</td></tr><tr><td colspan="2">......</td><td style='text-align: center; word-wrap: break-word;'>......</td><td style='text-align: center; word-wrap: break-word;'>......</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>7</td><td style='text-align: center; word-wrap: break-word;'>00401088</td><td style='text-align: center; word-wrap: break-word;'>7D 32</td><td style='text-align: center; word-wrap: break-word;'>jge 004010bch</td></tr></table>
<div style="text-align: center;">

<img src="../../../../origin/2027计算机组成原理/imgs/img_95.jpg">
...
05. 【2024 统考真题】假定计算机 M 字长为 32 位，按字节编址，采用 32 位定长指令字，指令 add、sli 和 lw 的格式、编码和功能说明如图(a)所示。

<table border=1 style='margin: auto; word-wrap: break-word;'><tr><td style='text-align: center; word-wrap: break-word;'>指令</td><td style='text-align: center; word-wrap: break-word;'>31</td><td style='text-align: center; word-wrap: break-word;'>25</td><td style='text-align: center; word-wrap: break-word;'>24</td><td style='text-align: center; word-wrap: break-word;'>20</td><td style='text-align: center; word-wrap: break-word;'>19</td><td style='text-align: center; word-wrap: break-word;'>15</td><td style='text-align: center; word-wrap: break-word;'>14</td><td style='text-align: center; word-wrap: break-word;'>12</td><td style='text-align: center; word-wrap: break-word;'>11</td><td style='text-align: center; word-wrap: break-word;'>7</td><td style='text-align: center; word-wrap: break-word;'>6</td><td style='text-align: center; word-wrap: break-word;'>0</td><td style='text-align: center; word-wrap: break-word;'>指令功能说明</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>add</td><td style='text-align: center; word-wrap: break-word;'>0000000</td><td style='text-align: center; word-wrap: break-word;'>rs2</td><td style='text-align: center; word-wrap: break-word;'>rs1</td><td style='text-align: center; word-wrap: break-word;'>000</td><td style='text-align: center; word-wrap: break-word;'>rd</td><td style='text-align: center; word-wrap: break-word;'>0110011</td><td colspan="7">R[rd]←R[rs1]+R[rs2]</td></tr><tr><td style='text-align: center; word-wrap: break-word;'>slli</td><td style='text-align: center; word-wrap: break-word;'>0000000</td><td style='text-align: center; word-wrap: break-word;'>shamt</td><td style='text-align: center; word-wrap: break-word;'>rs1</td><td style='text-align: center; word-wrap: break-word;'>010</td><td style='text-align: center; word-wrap: break-word;'>rd</td><td style='text-align: center; word-wrap: break-word;'>0010011</td><td colspan="7">R[rd]←R[rs1]<<shamt</td></tr><tr><td style='text-align: center; word-wrap: break-word;'